...
const pcvar_t pjk_g_cvars[] = {
	...
	{ PJK_GAME_BOUNCYROCKETS_CVAR,					PJK_GAME_BOUNCYROCKETS_DVAL,					PJK_GAME_BOUNCYROCKETS_FLAG,							qtrue },
};
...
const pcvar_t pjk_bg_cvars[] = {
	...
	{ PJK_BGAME_THERMAL_GOLF_CVAR,					PJK_BGAME_THERMAL_GOLF_DVAL,						PJK_BGAME_THERMAL_GOLF_FLAG,								qtrue },
};
